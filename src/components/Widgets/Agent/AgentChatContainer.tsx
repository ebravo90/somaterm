          ...
          <div className="flex flex-col h-full">
            <div className="px-4 py-2 border-b border-soma-border bg-soma-bg/50 backdrop-blur-md z-10 shrink-0 relative flex gap-2" ref={dropdownRef}>
              ...
              <button
                ...
                className="shrink-0 bg-soma-bg border border-soma-border hover:bg-red-500/20 hover:text-red-400 hover:border-red-500/50 transition-colors text-soma-text-muted rounded-md px-2 flex items-center justify-center cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={!activeSessionId || currentMessages.length === 0 || isGenerating}
                title="Clear Chat"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

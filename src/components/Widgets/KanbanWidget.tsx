...
import { KANBAN_COLUMNS, STATUS_OPTIONS, PRIORITY_OPTIONS, TYPE_OPTIONS } from './Kanban/KanbanConstants';
import { InlineStatusBadge, InlineAssigneeDropdown } from './Kanban/KanbanInlineControls';
              ...
              {isEditing ? (
                ...
                <>
                  ...
                  <div className="flex items-center gap-2 mb-10">
                    ...
                    <InlineAssigneeDropdown ticket={selectedTicketObj} isFullView={true} />
                  </div>
                </>
              )}
